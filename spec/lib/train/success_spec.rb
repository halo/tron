...
RSpec.describe Tron::Success do
  describe '#on_success' do
    context 'passing in a proc' do
      it 'calls the proc and returns its instance' do
        ...
        expect(instance.on_success(proc { :bingo })).to eq :bingo
      end
    end
    ...
    context 'calling it with a block' do
      it 'calls the block and returns its instance' do
        instance = described_class.new
        expect(instance.on_success { :bingo }).to eq :bingo
      end
    end
  ...
  describe '#on_failure' do
    context 'passing in a proc' do
      it 'returns self' do
        instance = described_class.new
        expect(instance.on_failure(proc { :not_you })).to be instance
      end
    end
    ...
    context 'calling it with a block' do
      it 'calls the block and returns its instance' do
        instance = described_class.new
        expect(instance.on_failure { :not_you }).to be instance
      end
    end
